...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    articales: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::articale.articale'
    >;
    groups: Attribute.Relation<
      ...
      'api::group.group'
    >;
    author_name: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::group.group'
    >;
...
export interface ApiArticaleArticale extends Schema.CollectionType {
  collectionName: 'articales';
  info: {
    singularName: 'articale';
    pluralName: 'articales';
    displayName: 'articale';
    description: '';
  };
  options: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::articale.articale': ApiArticaleArticale;
